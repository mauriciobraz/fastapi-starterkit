...
from .error_response import ErrorResponseModel, ErrorInfoContainer

from .exception_types import DataException, ServiceException
...
class ExceptionHandlers:
    ...
    def http_exception(request, exc: HTTPException):
        return JSONResponse(
            ...
            content=ExceptionHandlers.__get_error_content(
                error_info=ErrorInfoContainer.unhandled_error, error_detail=[exc.detail]
            ),
        )
